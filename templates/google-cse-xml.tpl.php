  ...
  <CustomSearchEngine id="<?php print $node->field_cu_google_cse_id['und'][0]['value']?>" creator="<?php print $node->field_cu_google_cse_creator['und'][0]['value']?>" language="en" encoding="UTF-8" enable_suggest="true">
    ...
    <Context>
      <BackgroundLabels>
        ...
        <Label name="_cse_exclude_<?php print $node->field_cu_google_cse_id['und'][0]['value']?>" mode="ELIMINATE" />
      </BackgroundLabels>
    </Context>
    <LookAndFeel nonprofit="false" element_layout="8" theme="7" text_font="Arial, sans-serif" url_length="full" element_branding="show" enable_cse_thumbnail="true" promotion_url_length="full">
      ...
      <Results border_color="#FFFFFF" border_hover_color="#FFFFFF" background_color="#FFFFFF" background_hover_color="#FFFFFF" ads_background_color="#FFFFFF" ads_border_color="#FFFFFF" />
    </LookAndFeel>
    <AdSense />
    <EnterpriseAccount />
